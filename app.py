# app.py
# -----------------------------
# One-file CrewAI + Groq + Streamlit research crew
# No getenv, no extra files, token-conscious prompts
# -----------------------------
...
st.caption("Single-file multi-agent research assistant with web lookup & Markdown export.")
